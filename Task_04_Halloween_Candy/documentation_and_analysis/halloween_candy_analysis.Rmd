...
test <- HC_data_cleaning_v2_long %>% 
  mutate(country = str_replace_all(country, c("unknown" = "unknown", "n. ausa" = "usa","narnia" = "unknown","neverland" = "unknown","new jersey" = "usa","new york" = "usa","north carolina" = "usa","not the usa or canada" = "usa","one of the best ones" = "unknown","pittsburgh" = "usa","see above" = "unknown","somewhere" = "unknown","soviet canuckistan" = " unknown","sub-canadian north usa... usa" = "usa","subscribe to dm4uz3 on youtube" = "unknown","the best one - usa" = "usa","the netherlands" = "netherlands","the republic of unknown" = "unknown","the united states" = "usa", "america" = "usa", "usaa" = "usa","ausa" = "usa","the yoo ess of aaayyyyyy" = "usa","there isn't one for old men" = "unknown","this one" = "unknown","trumpistan" = "usa","u s" = "usa","^u.k.$" = "uk","^u.s.$" = "usa","^u.s.a.$" = "usa","unhinged states" = "usa", "cascadia" = "unknown","denial" = "unknown","earth" = "unknown","endland" = "england","españa" = "spain","eua" = "uae","fear and loathing" = "unknown","god's country" = "unknown","i don't know anymore" = "unknown","i pretend to be from canada, but i am really from usa." = "usa","insanity lately" = "unknown", "atlantis" = "unknown","california" = "usa", "'merica" = "usa", "^a$" = "unknown", "a tropical island south of the equator" = "unknown", "ahem....amerca" = "usa", "(^[uni][a-z]+[:space:]+[s][a-t]{4})" = "usa", "((usa)+([:punct:]|[:space:])+(usa))+([:punct:]|[:space:]?)" = "usa"))) 


test <- HC_data_cleaning_v2_long %>% 
  mutate(country = str_replace_all(country, c("(^uni[a-z]+[:space:]+s[a-t]{4})" = "usa", "((usa)+([:punct:]|[:space:])+(usa))+([:punct:]|[:space:]?)" = "usa"))) 
